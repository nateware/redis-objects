...
Using an ORM layer that retrieves a "record", updates values, then sends those values back,
...
4. Higher-level type are provided, such as Locks, that wrap multiple calls
